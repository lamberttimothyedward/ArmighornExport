...
namespace InfiniteCareExport2
{

    public class CourseRootobject2
    {
        public CACourseMeta meta { get; set; }
        public Course_Templates[] course_templates { get; set; }
    }

    public class CACourseMeta
    {
    ...
    public class Course_Templates
    {
        ...
        public Branding_Override branding_override { get; set; }
        ...
        public object next_section_due { get; set; }
    ...
    public class Branding_Override
    {
