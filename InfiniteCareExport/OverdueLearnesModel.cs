...
namespace InfiniteCareExport
{
    ...
    public class OLRootobject
    {
        public OLMeta meta { get; set; }
    ...
    public class Report
    {
        ...
        public OLDatum[] data { get; set; }
        public OLData_Types data_types { get; set; }
    }

    public class OLData_Types
    {
